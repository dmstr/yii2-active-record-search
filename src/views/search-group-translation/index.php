 ...
 * @var dmstr\activeRecordSearch\models\search\SearchGroupTranslation $searchModel
 */
$this->title = Yii::t('search', 'Search Group Translations');
...
?>
<div class="giiant-crud search-group-translation-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('search', 'Search Group Translations') ?>
        <small>
            List
        </small>
    </h1>
