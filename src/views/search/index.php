 ...
 * @var dmstr\activeRecordSearch\models\search\Search $searchModel
 */
$this->title = Yii::t('search', 'Searches');
...
?>
<div class="giiant-crud search-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('search', 'Searches') ?>
        <small>
            List
        </small>
    </h1>
...
\yii\bootstrap\ButtonDropdown::widget(
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['/search/search-group/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('search', 'Search Group'),
				],
    ...
    <div class="table-responsive">
		...
		'columns' => [
			...
			[
                ...
                'filter' => yii\helpers\ArrayHelper::map(dmstr\activeRecordSearch\models\SearchGroup::find()->all(), 'ref_name', 'label'),
				'attribute' => 'group',
				'value' => function ($model) {
					if ($rel = $model->groupRef) {
						return Html::a($rel->label, ['/search/search-group/view', 'id' => $rel->id, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
